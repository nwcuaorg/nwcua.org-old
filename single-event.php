		...
		<div id="content" class="site-content content-two-column wrap group" role="main">
			<div class="third right event-info">
				...
				if ( !get_cmb_value( 'event_registration_hide' ) ) {
					print '<p style="padding-top: 20px;"><a href="' . ( has_cmb_value( 'event_registration' ) ? get_cmb_value( 'event_registration' ) : 'https://nwcua.force.com/s/product/' . get_cmb_value( 'event_id' ) ) . '" class="btn-arrow green">Register Now</a></p>';
				}
