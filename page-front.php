...
?>
	...
	<div class="browse-by">
		<div class="wrap">
			<div class="browse-by-filters">
				...
				<div class="quarter">
				<?php 
				$categories = get_categories( 'exclude=1,4,20,30,31,36,38,39,42,43,44,45,47,48,49,50,51,53,54,56,1238,1276,1277,1278,1282,1284,1285,1286,1315,7571,7580,7581,7582,7585,7586,7588,7589,7590,7592,7677,7850,7851,7852,7853' );
	...
	<div id="primary" class="site-content">
		...
		$query_args['exclude'] = '7850,7851,7852,7853';
			...
			if ( $wp_query->have_posts() ) {
				...
				while ( $wp_query->have_posts() ) : $wp_query->the_post();
					...
					if ( $count == 1 && !empty( $events ) ) {						
						...
						print "<h3><a href='/events/'>Upcoming Events</a> <sup><a href='https://nwcua.org/wp-content/uploads/2018/03/2018-NWCUA-Events-Handout.pdf'>[PDF]</a></sup></h3>";
						// list the events
